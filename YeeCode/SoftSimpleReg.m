...
tSim = 200e-15
f = 230e12; %frequency variable for testing at different rates.
lambda = c_c/f;
...
mu{1} = ones(nx{1},ny{1})*c_mu_0; %this sets up a matrix for vaccum permeability using nx and ny
...
%the code below sets up the plot and its attributes
movie = 1;
Plot.off = 0;
Plot.pl = 0;
Plot.ori = '13';
...
%Below are conditions for the boundaries
